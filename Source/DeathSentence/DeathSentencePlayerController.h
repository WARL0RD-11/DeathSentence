...
#include "DeathSentencePlayerController.generated.h"

class UInputMappingContext;
class ADeathSentencePawn;
class UDeathSentenceUI;
 ...
 */
UCLASS(abstract)
class ADeathSentencePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ADeathSentencePawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ADeathSentencePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UDeathSentenceUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UDeathSentenceUI> VehicleUI;
