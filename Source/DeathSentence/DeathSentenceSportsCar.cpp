...
#include "DeathSentenceSportsCar.h"
#include "DeathSentenceSportsWheelFront.h"
#include "DeathSentenceSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ADeathSentenceSportsCar::ADeathSentenceSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDeathSentenceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDeathSentenceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDeathSentenceSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDeathSentenceSportsWheelRear::StaticClass();
