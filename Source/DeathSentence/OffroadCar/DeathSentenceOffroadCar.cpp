...
#include "DeathSentenceOffroadCar.h"
#include "DeathSentenceOffroadWheelFront.h"
#include "DeathSentenceOffroadWheelRear.h"
...
ADeathSentenceOffroadCar::ADeathSentenceOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDeathSentenceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDeathSentenceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDeathSentenceOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDeathSentenceOffroadWheelRear::StaticClass();
